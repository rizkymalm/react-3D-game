        ...
        >
            ...
            <div className="orbitron-bold flex h-full w-full flex-col gap-2 px-4 py-2">
                <div className="relative w-full">
                    <p className="ty-body tier-silver font-medium">Attack</p>
                ...
                <div className="relative w-full">
                    <p className="ty-body tier-silver font-medium">Defense</p>
                    <div className="progress-bar bg-light-3/20">
                        <div
                            className={`progress transition-all duration-1000`}
                            style={{
                ...
                <div className="relative w-full">
                    <p className="ty-body tier-silver font-medium">Ulti</p>
                    <div className="progress-bar bg-light-3/20">
                        <div
                            className={`progress transition-all duration-1000`}
                            style={{
                ...
                <div className="relative w-full">
                    <p className="ty-body tier-silver font-medium">Ability</p>
                    <div className="progress-bar bg-light-3/20">
                        <div
                            className={`progress transition-all duration-1000`}
                            style={{
